...
--
-- Counts every finished duel (friend or bot) -- incremented once per
-- duel from computeDuelResult(), which is already guarded by
-- duelResultFinalized so a duel can never double-count its own result.
